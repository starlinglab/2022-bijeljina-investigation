# From the integrity-preprocessor contrib folder. to be moved back there
...
endrow = 1000000000
filename = "bosnia.csv"
config_filename = "bosnia.conf"
target_filename = "bosnia.json"
# Load config
            ...
            if filename != "":
                ...
                for mapping in config["fieldsMap"]:
                    if mapping == "sourceId":
                        ...
                        if json_metadata[config["fieldsMap"][mapping]] != "":
